...
from utils import get_broadcast_cand, dict_to_tuple, tuple_to_dict, get_test_data, check_cand, tuple_to_dict_backbone
...
class EvolutionSearcher(object):
    ...
    def is_legal(self, arch, **kwargs):
        ...
        #     del size, fp, cfg
        #     return False
        if (self.flops_limit and fp > self.flops_limit): # 硬件约束筛选,only FLOPs
            del size, fp, cfg
            return False
    ...
    def get_mutation(self, k, mutation_num, m_prob):
        ...
        while len(res) < mutation_num and max_iters > 0:
            ...
            cand = tuple_to_dict_backbone(cand_tuple)
            cand = get_broadcast_cand(cand, self.distributed, rank)
            # print(cand)
    ...
    def search(self):
        ...
        while self.epoch < self.max_epochs:
            ...
            for i, cand in enumerate(self.keep_top_k[50]):
                ...
                cand_dict = tuple_to_dict_backbone(cand)
