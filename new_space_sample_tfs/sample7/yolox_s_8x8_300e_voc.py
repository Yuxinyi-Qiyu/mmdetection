...
log_level = 'INFO'
load_from = None
resume_from = 'new_space_sample_tfs/sample7/epoch_200.pth'
workflow = [('train', 1)]
...
model = dict(
    ...
    backbone=dict(
        type='CSPDarknet',
        deepen_factor=0.33,
        widen_factor=[0.125, 0.125, 0.5, 0.125, 0.125]),
    neck=dict(
        type='YOLOXPAFPN',
        in_channels=[128, 64, 128],
        out_channels=128,
        widen_factor=[0.25, 0.125, 0.25, 0.125, 0.125, 0.5, 0.5, 0.125],
...
work_dir = 'new_space_sample_tfs/sample7'
auto_resume = False
gpu_ids = range(0, 8)
