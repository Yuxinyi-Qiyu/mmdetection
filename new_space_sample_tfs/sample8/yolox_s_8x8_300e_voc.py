...
model = dict(
    ...
    backbone=dict(
        type='CSPDarknet',
        deepen_factor=0.33,
        widen_factor=[0.5, 0.375, 0.375, 0.5, 0.125]),
    neck=dict(
        type='YOLOXPAFPN',
        in_channels=[96, 256, 128],
        out_channels=64,
        widen_factor=[0.5, 0.375, 0.25, 0.375, 0.375, 0.375, 0.25, 0.375],
...
work_dir = 'new_space_sample_tfs/sample8'
auto_resume = False
gpu_ids = range(0, 8)
