...
log_level = 'INFO'
load_from = None
resume_from = 'new_space_sample_tfs/sample9/epoch_150.pth'
workflow = [('train', 1)]
...
model = dict(
    ...
    backbone=dict(
        type='CSPDarknet',
        deepen_factor=0.33,
        widen_factor=[0.5, 0.375, 0.125, 0.125, 0.375]),
    neck=dict(
        type='YOLOXPAFPN',
        in_channels=[32, 64, 384],
        out_channels=32,
        widen_factor=[0.5, 0.125, 0.25, 0.25, 0.25, 0.375, 0.25, 0.5],
...
work_dir = 'new_space_sample_tfs/sample9'
auto_resume = False
gpu_ids = range(0, 8)
