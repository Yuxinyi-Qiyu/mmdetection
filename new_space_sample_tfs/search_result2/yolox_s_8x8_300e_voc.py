...
model = dict(
    ...
    backbone=dict(
        type='CSPDarknet',
        deepen_factor=0.33,
        widen_factor=[0.125, 0.375, 0.375, 0.25, 0.375]),
    neck=dict(
        type='YOLOXPAFPN',
        in_channels=[96, 128, 384],
        out_channels=32,
        widen_factor=[0.25, 0.125, 0.5, 0.5, 0.375, 0.5, 0.5, 0.375],
...
work_dir = 'new_space_sample_tfs/search_result2'
auto_resume = False
gpu_ids = range(0, 8)
